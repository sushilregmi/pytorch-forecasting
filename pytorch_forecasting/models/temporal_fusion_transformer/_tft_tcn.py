    ...
    **kwargs: additional arguments to :py:class:`~BaseModel`.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # MODIFIED: Replaced LSTM encoder/decoder with TCN encoder/decoder
        # tcn encoder (history) and decoder (future) for local processing
        ...
        # MODIFIED: Renamed post-processing layers for clarity (from post_lstm_* to post_tcn_*)
        # skip connection for TCN
    ...
    def forward(self, x: dict[str, torch.Tensor]) -> dict[str, torch.Tensor]:
        ...
        # MODIFIED: Replaced LSTM block with TCN block
        # TCN expects input of shape (batch, channels, time)
        # run local encoder
