...
class TemporalFusionTransformer(BaseModelWithCovariates):
    ...
    **kwargs: additional arguments to :py:class:`~BaseModel`.
    ...
    def forward(self, x: dict[str, torch.Tensor]) -> dict[str, torch.Tensor]:
        ...
        encoder_output = self.tcn_encoder(embeddings_varying_encoder.permute(0, 2, 1)).permute(0, 2, 1)
        ...
        decoder_output = self.tcn_decoder(embeddings_varying_decoder.permute(0, 2, 1)).permute(0, 2, 1)
